...
import { Megaphone, Plus, Edit, Trash2, BarChart3, Target } from "lucide-react";
...
export default function MarketingAdminPage() {
  ...
  const kpis = businessUnits.marketing?.kpis || [];
  const initiatives = businessUnits.marketing?.initiatives || [];
  ...
  const handleSaveInitiative = (initiativeData: any) => {
    if (editingInitiative) {
      updateInitiative("marketing", {
        ...initiativeData,
        id: editingInitiative.id,
      });
      setEditingInitiative(null);
    } else {
      addInitiative("marketing", initiativeData);
    }
  ...
  const handleDeleteKPI = (id: number) => {
    if (confirm("Are you sure you want to delete this KPI?")) {
      deleteKPI("marketing", id);
    }
  };

  const handleDeleteInitiative = (id: number) => {
    if (confirm("Are you sure you want to delete this initiative?")) {
      deleteInitiative("marketing", id);
    }
  };
        ...
        <div className="flex items-center mb-8">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600">
              Manage KPIs and initiatives for marketing performance tracking
            </p>
          </div>
        </div>
